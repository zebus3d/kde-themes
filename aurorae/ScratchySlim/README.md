...
Fork propio de la decoracion de ventanas Aurorae **Scratchy**, creado el 2026-09-01.
El tema original sigue instalado y sin modificar en `../Scratchy/`.
...
| Clave en `[Layout]` | Scratchy | ScratchySlim |
|---|---|---|
| `BorderLeft` | 2 | 2 |
| `BorderRight` | 2 | 2 |
| `BorderBottom` | 7 | **2** |
...
```bash
id=$(qdbus6 org.kde.KWin /Scripting org.kde.kwin.Scripting.loadScript ~/.local/share/aurorae/themes/ScratchySlim/borders.js probe)
